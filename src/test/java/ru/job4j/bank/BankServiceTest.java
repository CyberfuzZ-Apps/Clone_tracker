...
public class BankServiceTest {
    ...
    public void noAddUser() {
        ...
        bank.addUser(user1);
        bank.addUser(user2);
        assertNotEquals("Evgeniy Zaycev", bank.findByPassport("3434")
                .get().getUsername());
    }
    ...
    public void whenEnterInvalidRequisite() {
        ...
        bank.addUser(user);
        bank.addAccount(user.getPassport(), new Account("5546", 150D));
        assertThat(bank.findByRequisite("3434", "55"), is(Optional.empty()));
    }
    ...
    public void whenNotFoundByPassport() {
        ...
        BankService bank = new BankService();
        bank.addUser(user);
        assertThat(bank.findByPassport("1111"), is(Optional.empty()));
    }
    ...
    public void add2Accounts() {
        ...
        assertThat(bank.findByRequisite("3434", "1111")
                .get().getBalance(), is(400D));
    }
    ...
    public void add3Accounts() {
        ...
        assertThat(bank.findByRequisite("3434", "3333")
                .get().getBalance(), is(500D));
    }
    ...
    public void transferMoney2() {
        ...
        bank.addAccount(user.getPassport(), new Account("113", 50D));
        bank.transferMoney(user.getPassport(), "5546", user.getPassport(), "113", 150D);
        assertThat(bank.findByRequisite(user.getPassport(), "5546")
    ...
    public void transferMoney3() {
        ...
        assertThat(bank.findByRequisite(user2.getPassport(), "113")
                .get().getBalance(), is(100D));
    }
}